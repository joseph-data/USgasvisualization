...
```{r}
#| fig-width: 12     # total width in inches
#| fig-height: 8     # total height in inches
#| fig-format: svg   # vector output for crisp lines in HTML
#| out-width: "100%" # scale the SVG to fill the page width
...
ggsave("images/monthly_boxplot.png", plot = p2, width = 8, height = 5, dpi = 600)
ggsave("images/weekly_changes.png", plot = p3, width = 9, height = 5, dpi = 600)
ggsave("images/diesel_vs_gasoline.png", plot = p4, width = 7, height = 5, dpi = 600)

# SVG (vector output)
ggsave("images/final_2x2_grid.svg", plot = final_plot, width = 12, height = 8, device = "svg")
